(function () {
...
})()(
  {
    ...
    2: [
      ...
      { "./events": 1, "./filterset": 3, "./group": 4, "./util": 11 },
    ],
    3: [
      function (require, module, exports) {
        "use strict";
    ...
    5: [
      ...
      { "./filter": 2, "./group": 4, "./input": 6, "./input_checkboxgroup": 7, "./input_selectize": 8, "./input_slider": 9, "./selection": 10 },
    ],
    6: [
      function (require, module, exports) {
        (function (global) {
                ...
                value: function set(value, /*optional*/ event) {
                  ...
                  if (global.Shiny && global.Shiny.onInputChange) {
                    global.Shiny.onInputChange(
                      ".clientValue-" + (this._group.name !== null ? this._group.name + "-" : "") + this._name,
